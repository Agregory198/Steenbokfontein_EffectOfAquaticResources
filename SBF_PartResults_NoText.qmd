...
df_sum25 <- read.csv("AG_Summer2025_SBF_final.csv") |>
  filter(RAWMATERIAL != "BWA UPPER 1" &
           RAWMATERIAL %in% c("Quartz", "Quartzite", "Silcrete")) |>
  mutate(STRAT = ifelse(STRAT == "3a", "3", # combine strat 3a and 3b
                        ifelse(STRAT == "3b", "3", STRAT)),
...
# Glenda's dataframe
df_glenda <- read_csv("DataSheet_Glenda.csv")|>
...
df_glenda <- df_glenda[1:289,]

df_glenda_flakes <- df_glenda |>
...
# Leano's Dataframe
df_leano <- read_csv("DataSheet_Leano.csv") |>
...
df_leano_flakes <- df_leano_flakes[1:421,] |>
  relocate(CORTEXTYPE, .before = "ARTIFACTCLASS")
  

df_students <- rbind(df_leano_flakes, df_glenda_flakes)
...
png("figures/fig5.png", width = 290, height = 120, units = "mm", res = 300)
ggarrange(
  RM_plot2, RM_plot1,
...
png("figures/fig6.png", width = 290, height = 120, units = "mm", res = 300)
...
png("figures/fig7.png", width = 290, height = 120, units = "mm", res = 300)
...
png("figures/fig8.png", width = 290, height = 120, units = "mm", res = 300)
...
png("figures/fig9.png", width = 290, height = 120, units = "mm", res = 300)
...
png("figures/fig10.png", width = 180, height = 120, units = "mm", res = 300)
...
png("figures/fig11.png", width = 180, height = 120, units = "mm", res = 300)
...
png("figures/fig12.png", width = 180, height = 120, units = "mm", res = 300)
...
png("figures/fig13.png", width = 180, height = 120, units = "mm", res = 300)
...
png("figures/fig14.png", width = 180, height = 120, units = "mm", res = 300)
